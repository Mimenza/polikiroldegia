...
<body >
	<div class="container mt-5 rounded border border-dark" ' >
		...
		<br>
		<div class="row">
			<div class="col text-center"><a href="EditarActividad?id=${actividad.getId()}" type="button" class="btn btn-primary btn-lg text-white">Editar</a></div>
		...
		<div class="row justify-content-center mb-5">
			<div class="col-2">
            	<a class="btn btn-warning btn-lg text-center" href="VerActividades" role="button">Volver</a>
