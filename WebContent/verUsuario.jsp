...
<body>
	<div class="container mt-5 rounded border border-dark" ' >
		...
		<br>
		<div class="row">
			<div class="col text-center"><a href="EditarActividad?id=${usuario.getId()}" type="button" class="btn btn-primary btn-lg text-white">Editar</a></div>
			<div class="col text-center"><a href="EliminarActividad?id=${usuario.getId()}" type="button" class="btn btn-danger btn-lg">Borrar</a></div>
		</div>
		<br>
		<div class="row justify-content-center mb-5">
			<div class="col-2">
            	<a class="btn btn-warning btn-lg text-center" href="VerUsuarios" role="button">Volver</a>
